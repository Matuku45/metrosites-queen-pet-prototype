  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-pink-100 px-6 py-12">
      ...
      >
        ...
        <form className="bg-white shadow-lg rounded-xl p-8 flex flex-col gap-4">
          <input type="text" placeholder="Your Name" className="input input-bordered w-full rounded-lg" />
          <input type="email" placeholder="Your Email" className="input input-bordered w-full rounded-lg" />
          <textarea placeholder="Your Message" rows={4} className="textarea textarea-bordered w-full rounded-lg"></textarea>
          <button className="btn bg-gradient-to-r from-pink-400 to-yellow-400 text-white border-none hover:scale-105 transition-transform rounded-xl">
            Send Message
          </button>
        </form>
      </motion.div>
